							...
							>
								<List component="div" disablePadding>
									...
									>
										...
										{/* Should contain add, edit, delete, adjust stock */}
								...
								<List component="div" disablePadding>
									<ListItemButton sx={{ pl: 4 }}>
										...
										<ListItemText primary="Low Stock/Out of Stock" />
									</ListItemButton>
								</List>
								<List component="div" disablePadding>
									<ListItemButton sx={{ pl: 4 }}>
